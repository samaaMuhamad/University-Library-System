...
<body>
    ...
    <div class="navbar">
        ...
        <div class="wrapper">
            <div>
                <form method="POST">
                    <input type="text" id="search" name="search" class="allInputs" placeholder="Search for ISBN">
...
if(isset($_POST['submit']))
{
    ...
    {
        $result= mysqli_query($conn, "SELECT * from book where bookISBN = '". $search . "'") or die("Invalid query");
        ...
        {
                echo '<script type="text/javascript"> alert("There are NO books with this ISBN in the Library.."); </script>';
        }
    }
}
mysqli_close($conn);
