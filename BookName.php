...
<body>
    ...
    <div class="navbar">
        ...
        <div class="wrapper">
            <div>
                <form method="POST">
                    <input type="text" id="search" name="search" class="allInputs" placeholder="Enter Book Name: ">
...
if(isset($_POST['submit']))
{
    ...
    {
        $result= mysqli_query($conn, "SELECT * from book where bookName = '". $search . "'") or die("Invalid query");
        ...
        {
                echo '<script type="text/javascript"> alert("There are NO books with this Name in the Library.."); </script>';
        }
    }
}
mysqli_close($conn);
