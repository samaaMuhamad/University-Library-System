...
<body>
    ...
    <div class="navbar">
        ...
        <div class="dropdown">
            <button class="dropbtn">Book Option
        <i class="fa fa-caret-down"></i>
        </button>
            <div class="dropdown-content">
                <a href="Borrow.php">Borrowing</a>
                <a href="ReturnBook.php">Returning</a>
                <a href="Extend.php">Extend Borrowing</a>
            </div>
        </div>
        <div class="dropdown">
...
{
    echo "<div class='welcome'><h1>Welcome Student </h1></div>";
    echo "<style>
    .welcome 
    {
        margin-left: 100px;
